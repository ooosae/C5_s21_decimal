...
START_TEST(s21_not_equal_7) {
  ...
  s21_decimal dec2 = {{12, 0, 0, 0x80010000}};
  ck_assert_int_eq(s21_is_not_equal(dec1, dec2), 1);
}
END_TEST
START_TEST(s21_not_equal_8) {
  s21_decimal dec3 = {{120000, 0, 0, 0x40000}};
  s21_decimal dec4 = {{12, 0, 0, 0x00000000}};
  ck_assert_int_eq(s21_is_not_equal(dec3, dec4), 0);
}
END_TEST
START_TEST(s21_not_equal_9) {
  s21_decimal dec5 = {{0, 0, 0, 0x00000000}};
  s21_decimal dec6 = {{00, 0, 0, 0x10000}};
  ck_assert_int_eq(s21_is_not_equal(dec5, dec6), 0);
}
END_TEST
START_TEST(s21_not_equal_10) {
  s21_decimal dec7 = {{0, 0, 0, 0x00000000}};
  s21_decimal dec8 = {{0, 0, 0, 0x80000000}};
