...
START_TEST(add_test_27) {
  int tmp1 = (int)4294967295;
  float tmp2 = pow(2, 31);
  s21_decimal dec1 = {{tmp1, tmp1, tmp1, (unsigned int)tmp2}};
  s21_decimal dec2 = {{1, 0, 0, (unsigned int)tmp2}};
  s21_decimal res1 = {{0}};
  int ret_s21 = s21_add(dec1, dec2, &res1);
...
START_TEST(add_test_28) {
  ...
  ck_assert_float_eq_tol(got_float, float_res, 1e-06f);
}
...
START_TEST(add_test_37) {
  ...
  src2.bits[3] = 0x20000;
  s21_decimal original_res = {0};
  original_res.bits[0] = 0x2BF5;
  original_res.bits[1] = 0x0;
  original_res.bits[2] = 0x0;
  original_res.bits[3] = 0x20000;
  s21_decimal s21_res = {0};
  s21_add(src1, src2, &s21_res);
  ck_assert_int_eq(s21_add(src1, src2, &s21_res), 0);
  ck_assert_int_eq(original_res.bits[0], s21_res.bits[0]);
...
START_TEST(s21_test_decimal_add_25) {
  s21_decimal c = {{0x1979, 0, 0, 0}};
  s21_decimal d = {{0x12189, 0, 0, 0}};
  s21_decimal etalon = {{0x13B02, 0, 0, 0}};
...
START_TEST(s21_test_decimal_add_26) {
  s21_decimal c = {{0x89E7FFFF, 0x8AC72304, 0, 0}};
  s21_decimal d = {{0x1, 0, 0, 0}};
  s21_decimal etalon = {{0x89E80000, 0x8AC72304, 0, 0}};
...
START_TEST(s21_test_decimal_add_28) {
  s21_decimal c = {{0x82E25AED, 0xF9E825AD, 0xB03EF094, 0x800E0000}};
  s21_decimal d = {{0x340972E, 0, 0, 0}};
  s21_decimal etalon = {{0x712ADAED, 0x2E3CE1F8, 0xB03EEF6D, 0x800E0000}};
...
START_TEST(s21_test_decimal_add_29) {
  s21_decimal c = {{0x82E25AED, 0xF9E825AD, 0xB03EF094, 0x800E0000}};
  s21_decimal d = {{0x481B1F98, 0xFBFD896D, 0x46D77, 0x80180000}};
  s21_decimal etalon = {{0xB629B5DA, 0xF9EA0C7F, 0xB03EF094, 0x800E0000}};
...
START_TEST(s21_test_decimal_add_simple_9) {
  s21_decimal c = {{1, 0, 0, 0x80000000}};
  s21_decimal d = {{1, 0, 0, 0}};
  s21_decimal etalon = {{0, 0, 0, 0}};
